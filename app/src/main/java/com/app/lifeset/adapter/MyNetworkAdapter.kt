...
import com.app.lifeset.activity.MyNetworkActivity
...
class MyNetworkAdapter(
    val mContext: MyNetworkActivity, val inviteList: ArrayList<InviteStudentModel>,
    val onClick: onItemClick
) : RecyclerView.Adapter<MyNetworkAdapter.MyViewHolder>() {
